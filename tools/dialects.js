...
exports.postgres = {
  ...
  getForeignKeysQuery: function(tableName, schemaName) {
    ...
    WHERE o.conrelid = (SELECT oid FROM pg_class WHERE relname = '" +
      tableName +
      "' LIMIT 1)"
    );
  },
  ...
  isSerialKey: function(record) {
    return (
      ...
      (_.has(record, "extra") && _.startsWith(record.extra, "nextval") && _.includes(record.extra, "_seq") && _.includes(record.extra, "::regclass"))
    );
  },
  /**
...
exports.mssql = {
   ...
   */
  isSerialKey: function(record) {
    return _.isObject(record) && exports.mssql.isPrimaryKey(record) && (_.has(record, "is_identity") && record.is_identity);
  }
};
